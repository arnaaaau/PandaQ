...
query : 'select' select_list 'from' table orderby';'                                      #query_senseClausules_orderby
      ...
      | 'select' select_list 'from' table (clausules|subquery_sintaxis)* ';'              #query_ambClausules
      | 'select' select_list 'from' table (clausules|subquery_sintaxis)* orderby';'       #query_ambClausules_i_orderby
      ;
...
subquery_sintaxis : 'where' alias 'in' '(' subquery ')';

subquery : 'select' select_list 'from' table                #subquery_senseClausules
         | 'select' select_list 'from' table clausules*     #subquery_ambClausules
         ;
